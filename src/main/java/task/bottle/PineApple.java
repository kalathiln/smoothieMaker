 ...
 *
 */
public class PineApple extends SmoothieIngredients{
	public PineApple(SmoothieBottle newSmoothie) {
		super(newSmoothie);

	}
	
	public String getDescription() {
		return tempSmoothie.getDescription() + " 100 ml PineApple \n";
	}
	
	public double getCost(){
		return tempSmoothie.getCost() + 1.00;
	}
	
	public double getCalories(){
		return tempSmoothie.getCalories() + 61;
	}
}
