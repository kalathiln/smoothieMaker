 ...
 *
 */
public class Orange extends SmoothieIngredients{
	public Orange(SmoothieBottle newSmoothie) {
		super(newSmoothie);

	}
	
	public String getDescription() {
		return tempSmoothie.getDescription() + " 100 ml Orange \n";
	}
	
	public double getCost(){
		return tempSmoothie.getCost() + .80;
	}
	
	public double getCalories(){
		return tempSmoothie.getCalories() + 47;
	}
}
