 ...
 *
 */
public class Carrot extends SmoothieIngredients{
	public Carrot(SmoothieBottle newSmoothie) {
		super(newSmoothie);

	}
	
	public String getDescription() {
		return tempSmoothie.getDescription() + " 100 ml Carrot \n";
	}
	
	public double getCost(){
		return tempSmoothie.getCost() + 1.0;
	}
	
	public double getCalories(){
		return tempSmoothie.getCalories() + 94;
	}
}
