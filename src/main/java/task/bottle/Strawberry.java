 ...
 *
 */
public class Strawberry extends SmoothieIngredients{
	public Strawberry(SmoothieBottle newSmoothie) {
		super(newSmoothie);

	}
	
	public String getDescription() {
		return tempSmoothie.getDescription() + " 100 ml Strawberry \n";
	}
	
	public double getCost(){
		return tempSmoothie.getCost() + 1.40;
	}
	
	public double getCalories(){
		return tempSmoothie.getCalories() + 33;
	}
}
